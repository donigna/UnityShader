...
public class StandardBasicEditor : StandardBasicGUI
{
    ...
    Dictionary<SmoothSource, string> smoothKeywords = new Dictionary<SmoothSource, string>()
    {
        {SmoothSource.MetallicAlpha, "_SMOOTH_FIRSTA"},
        {SmoothSource.AlbedoAlpha, "_SMOOTH_ALBEDOA"},
        {SmoothSource.FirstMapRedChannel, "_SMOOTH_FIRST"},
    ...
    Dictionary<MetalSource, string> metalKeywords = new Dictionary<MetalSource, string>()
    {
    ...
    Dictionary<OcclusionSource, string> aoKeywords = new Dictionary<OcclusionSource, string>()
    {
    ...
    void MainMaps()
    {
        ...
        SingleLineTexture("_BumpMap", "_NormalStrength", tooltip: "Put normal maps here!");
