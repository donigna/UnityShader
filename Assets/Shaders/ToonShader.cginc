#ifndef TOON_SHADER_LIBRARY_INCLUDED
#define TOON_SHADER_LIBRARY_INCLUDED
...
void InitLightingToon(half4 threshold, half smoothness, half3 shadowColor, half highlightSize, half highlightSmoothness, half3 highlightColor)
{
...
half4 LightingToon(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
{
        ...
        half gloss = smoothstep(0.5, max(0.5, _ToonGlossSmoothness), halfDot);
        c.rgb = lerp(c.rgb, _LightColor0.rgb * _ToonGlossColor, gloss);
        return c;
}
